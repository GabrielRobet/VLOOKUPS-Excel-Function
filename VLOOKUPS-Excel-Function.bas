Function VLOOKUPS( _
    ...
    ReturnValue_ColIndex As Integer)
    ...
    If ReturnValue_ColIndex > DataRange.Columns.Count Then
    ...
    Else
        ...
        If MatchingRow <> 0 Then VLOOKUPS = DataRange.Cells(MatchingRow, ReturnValue_ColIndex)
